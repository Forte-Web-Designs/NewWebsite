            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-600" style={{height: '300px'}}>
                  ...
                  {/* Street View Hint Overlay */}
                  <div className="absolute bottom-4 right-4 bg-blue-600/90 text-white rounded-lg px-3 py-2 text-xs font-medium shadow-lg animate-pulse">
                    💡 Drag yellow person icon for Street View
                  </div>
