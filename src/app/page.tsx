              ...
              >
                {[...googleReviews, ...googleReviews].map((review, index) => (
                  <SimpleScrollReveal key={`${review.id}-${index}`} direction="up" delay={index * 100}>
                    <div className="flex-shrink-0 w-80 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              {formSubmitted ? (
                ...
                <>
                  <p className="text-gray-600 dark:text-gray-400 mb-6 text-center">
                    Ready to transform your online presence? Let's discuss your project and see how we can help grow your business.
                  </p>
