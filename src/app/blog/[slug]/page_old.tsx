...
const blogPosts = [
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Gmail's Smart Reply:</strong> AI-powered email responses (Free)</li>
      ...
      <ul>
        ...
        <li><strong>Grammarly:</strong> AI writing assistant ($12/month)</li>
      ...
      <ul>
        <li><strong>Canva AI:</strong> Design graphics, presentations, social posts ($15/month)</li>
      ...
      <h4>Online Stores</h4>
      <ul>
        <li><strong>Shopify AI:</strong> Product descriptions, SEO ($29/month)</li>
      ...
      <ul>
        ...
        <li>Add Grammarly for professional writing ($12/month)</li>
      </ul>
      ...
      <ul>
        <li><strong>Voice AI:</strong> Voice-activated business tools and customer service</li>
