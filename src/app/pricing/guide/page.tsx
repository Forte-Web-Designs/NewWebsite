          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <p className="text-gray-600 dark:text-gray-400">
                Select the services you're interested in to see your total monthly investment:
              </p>
              
              {/* Calculator would go here - this is a placeholder for the interactive component */}
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Interactive calculator coming soon! 
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
                  For now, use the scenarios above or contact us for a custom quote.
                </p>
              </div>
            </div>
          </div>
