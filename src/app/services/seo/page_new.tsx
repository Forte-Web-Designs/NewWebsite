...
export const metadata: Metadata = {
  title: "Local SEO Services – Rank #1 on Google & Get More Customers | Forte Web Designs",
  description: "Stop being invisible on Google. Our proven SEO strategies help local businesses rank higher, attract more qualified leads, and grow their customer base. Results in 30-60 days.",
};
