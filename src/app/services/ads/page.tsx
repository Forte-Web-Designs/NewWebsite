    ...
    <section className="container max-w-7xl mx-auto flex flex-col items-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 dark:bg-primary-1150 bg-secondary-1350 rounded-[20px] w-full mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="flex justify-center items-center p-6 sm:p-8 relative order-1 lg:order-2">
            <div>
              <OptimizedImage
                src="/images/services/ppc-start.png"
                className="dark:hidden block w-full max-w-md"
                width={472}
                height={460}
              ...
              <OptimizedImage
                ...
                className="dark:block hidden w-full max-w-md"
                width={472}
                height={460}
                alt="Descriptive text"
              />
            </div>
            <div className="absolute top-0 w-full h-full hidden lg:flex flex-col justify-between">
              <div className="flex justify-end min-[1400px]:-mr-20 min-[1280px]:-mr-8 -mr-5 rounded-[11px] h-[200px] -mt-7">
                <OptimizedImage
                  src="/images/services/Frame_1410088839.png"
                  className="w-[280px] h-[171px] shadow-[-10px_10px_30px_0px_rgba(0,0,0,0.3)] rounded-lg dark:block hidden"
                  width={280}
                  height={171}
                  alt="Descriptive text"
                />
                <OptimizedImage
                  ...
                  className="w-[280px] h-[171px] shadow-[-10px_10px_30px_0px_rgba(0,0,0,0.3)] rounded-lg dark:hidden block"
                  width={280}
                  height={171}
                  alt="Descriptive text"
                />
              </div>
              <div className="-ml-20 -mb-28 rounded-[11px] h-[220px]">
                <OptimizedImage
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6 sm:gap-8 mb-8 sm:mb-12">
