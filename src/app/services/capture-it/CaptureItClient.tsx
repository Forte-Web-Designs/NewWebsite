...
export default function CaptureItClient() {
  const services = [
    {
      title: "Landing Pages",
      description: "Pages built to do one thing: get the visitor to take the next step. Not your homepage. A real landing page."
    },
    {
      title: "Funnels",
      description: "Multi-step flows that walk someone from interested to booked, signed up, or purchased. Tracked at every step."
    },
    {
      title: "Booking and Forms",
      description: "Scheduling pages, intake forms, quote request forms. All wired into your CRM so nothing sits in an inbox."
    },
    {
      title: "Lead Magnets",
      description: "Guides, checklists, free tools, whatever makes sense for your business. Something worth exchanging an email for."
    }
  ];

  const problems = [
    {
      problem: "We're running ads to our homepage and hoping people call us.",
      solution: "That's like putting up a billboard that says 'we exist.' We build the page that actually captures the lead and moves them forward."
    },
    {
      problem: "People visit our site but nobody fills anything out.",
      solution: "Usually the page doesn't give them a clear next step. Or it asks too much too soon. We build pages that make the next step obvious."
    },
    {
      problem: "We have forms but leads just sit in our email.",
      solution: "A form that goes to an inbox isn't a system. We wire everything into your CRM so leads are tagged, routed, and followed up with automatically."
    }
  ];
          ...
          <SimpleScrollReveal direction="up">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-10">
                Traffic is expensive. Don't waste it on a page that does nothing.
              </p>
          ...
          <SimpleScrollReveal direction="up">
            <div className="space-y-6 mb-10">
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">1. Discovery</span> - I look at where your traffic is going today and where you're losing people.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">2. Build</span> - I build the pages, the forms, the tracking. Everything connected to your CRM.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">3. Handoff</span> - You own every page, every form, every connection. Documented and handed off clean.
              </p>
            </div>
            <p className="text-gray-600 dark:text-gray-400 text-center">
              Timeline: 1-3 weeks. You'll see where your leads are actually going.
            </p>
          </SimpleScrollReveal>
        </div>
      </section>
