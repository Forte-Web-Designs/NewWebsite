...
export default function KeepAndGrowClient() {
  const services = [
    {
      title: "Review Requests",
      description: "Automated requests that go out after a project or purchase. Timed right, worded right, sent to the right platform."
    },
    {
      title: "Referral Systems",
      description: "Make it easy for happy clients to send you business. A link, a message, an incentive if it fits. Built into the flow, not an afterthought."
    },
    {
      title: "Reactivation Campaigns",
      description: "Past clients who went quiet don't mean they're gone. We build the campaigns that bring them back at the right time with the right message."
    },
    {
      title: "Repeat and Renewal",
      description: "For businesses with recurring services or products. Automatic sequences that keep the relationship going and the revenue coming."
    }
  ];

  const problems = [
    {
      problem: "We close the deal and never really follow up again.",
      solution: "That's the most common missed opportunity in any business. Your existing clients already trust you. We build the system that keeps you in front of them."
    },
    {
      problem: "We get reviews sometimes but it's random.",
      solution: "Because nobody asks consistently. We automate the ask so it happens every time, timed to when the client is happiest."
    },
    {
      problem: "We know we should do more with our past client list but never get to it.",
      solution: "There's revenue sitting in that list. We build the campaigns that activate it without you having to remember or find the time."
    }
  ];
          ...
          <SimpleScrollReveal direction="up">
            <div className="text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-10">
                Your past customers are the cheapest sale you'll ever make. Talk to them.
              </p>
          ...
          <SimpleScrollReveal direction="up">
            <div className="space-y-6 mb-10">
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">1. Discovery</span> - I look at your client history and figure out where the easiest wins are.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">2. Build</span> - I build the campaigns, the triggers, the sequences. All connected to your CRM.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900 dark:text-white">3. Handoff</span> - Everything documented. You can see what's going out, to whom, and when.
              </p>
            </div>
            <p className="text-gray-600 dark:text-gray-400 text-center">
              Timeline: 2-4 weeks. Past clients start hearing from you again.
            </p>
          </SimpleScrollReveal>
        </div>
      </section>
