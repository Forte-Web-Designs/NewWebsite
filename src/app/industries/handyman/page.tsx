            ...
            <SimpleScrollReveal direction="left" delay={100}>
              <div className="text-center lg:text-left">
                ...
                <div className="flex justify-center lg:justify-start mb-6 sm:mb-8">
                  <Link href="/contact?industry=handyman" className="bg-amber-600 hover:bg-amber-700 w-full sm:w-auto text-white font-bold py-4 px-8 rounded-lg transition-colors">
              ...
              <SimpleAnimatedCard key={index}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow">
                  <div className="flex justify-center mb-4">
                    {getCompanyLogo(company.name, 'handyman', "w-16 h-16")}
                  </div>
