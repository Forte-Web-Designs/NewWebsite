            ...
            <SimpleScrollReveal direction="left" delay={100}>
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  <span className="text-sky-300">Never Miss Another Call.</span>
                </h1>
                ...
                <div className="bg-sky-800/30 rounded-lg p-4 mb-8">
                ...
                <div key={index} className="text-center">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 mb-3">
                    <div className="flex justify-center mb-3">
                      {getCompanyLogo(company.name, 'electrician', "w-12 h-12")}
                    </div>
