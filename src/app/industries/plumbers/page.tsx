...
export const metadata: Metadata = {
  title: 'Plumber Websites That Generate Leads | Forte Web Designs',
  description: 'Professional plumbing websites designed to convert emergency calls into customers. Mobile-optimized, fast-loading, and built for local SEO success.',
...
export default function PlumbersPage() {
  ...
  return (
    <div className="min-h-screen">
            ...
            <SimpleScrollReveal direction="left" delay={100}>
              <div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                  Plumber Websites That Convert <span className="text-blue-300">Emergency Calls</span> Into Customers
                </h1>
              ...
              <div className="relative">
                <div className="bg-white rounded-2xl p-8 shadow-2xl">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Emergency Plumbing</h3>
                    <p className="text-gray-600 mb-6">24/7 Service in Dallas Metro</p>
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex justify-between items-center py-2">
                        ...
                        <span className="font-semibold text-orange-600">Call Now</span>
                      </div>
                    </div>
                    
                    <button className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-lg font-semibold text-lg transition-colors">
      ...
      {/* Why We're Plumbing Experts Section */}
