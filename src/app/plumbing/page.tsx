...
// Default demo data for Forte Plumbing
const fortePlumbingData = {
  name: "Your City",
  state: "Your State",
  phoneNumber: "(555) 123-PIPE",
  heroHeadline: "Professional Plumbing Services in Your Area",
  heroSubtext: "Fast, reliable, and affordable plumbing solutions. Emergency services available 24/7 for all your plumbing needs.",
  ...
  zipCodes: ["12345", "12346", "12347", "12348", "12349"],
  aboutText: "Forte Plumbing has been serving our community for over 15 years with professional, reliable plumbing services. Our team of licensed plumbers is committed to providing quality workmanship and exceptional customer service for all your residential and commercial plumbing needs.",
  serviceBenefits: [
...
export default function PlumbingDemoPage() {
  ...
  useEffect(() => {
    // Set page title
    document.title = `Forte Plumbing - Professional Plumbing Services | Demo`;
  ...
  const handlePhoneCall = () => {
    window.location.href = `tel:${fortePlumbingData.phoneNumber}`;
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <span className="text-white">{fortePlumbingData.phoneNumber}</span>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              {fortePlumbingData.heroHeadline}
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              {fortePlumbingData.heroSubtext}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Call {fortePlumbingData.phoneNumber}
              </button>
              <button
                onClick={() => scrollToSection('contact')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Serving {fortePlumbingData.serviceArea} with reliable, professional plumbing solutions.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Why Choose Forte Plumbing?
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                {fortePlumbingData.aboutText}
              </p>
              <div className="space-y-4">
                {fortePlumbingData.serviceBenefits.map((benefit, index) => (
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-600">{fortePlumbingData.serviceArea}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">Neighborhoods:</h4>
                  <p className="text-gray-600">{fortePlumbingData.neighborhoods.join(', ')}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900">ZIP Codes:</h4>
                  <p className="text-gray-600">{fortePlumbingData.zipCodes.join(', ')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Contact Forte Plumbing today for fast, reliable plumbing services in your area.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={handlePhoneCall}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Professional plumbing services in your area. 
                Licensed, insured, and trusted by {fortePlumbingData.population} residents.
              </p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Service Areas</h4>
              <ul className="text-gray-400 space-y-2">
                {fortePlumbingData.neighborhoods.slice(0, 4).map((neighborhood, index) => (
            ...
            <div>
              ...
              <div className="text-gray-400 space-y-2">
                <p>📞 {fortePlumbingData.phoneNumber}</p>
                <p>📍 Serving {fortePlumbingData.serviceArea}</p>
