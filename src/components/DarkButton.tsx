...
export default function DarkButton({
  ...
  const buttonClasses = `bg-black px-5 py-3 text-white rounded-3xl flex items-center justify-center gap-2 whitespace-nowrap transition-all duration-300 hover:bg-gray-800 hover:scale-105 hover:shadow-lg cursor-pointer ${className}`;
  const buttonStyle = {
