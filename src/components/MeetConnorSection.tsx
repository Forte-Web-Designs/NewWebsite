              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4 text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                    ...
                    <p>
                      No bloated plugins, no surprise crashes, no "sorry, that'll be an extra $200" fees. Whether you go with our Forte Foundation™ to get started or create something completely custom with Forte Pro™, you're getting a partner who genuinely cares about your success.
                    </p>
                  </div>
                </div>
